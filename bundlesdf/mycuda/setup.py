...
candidate_eigen_dirs = [
    "/usr/local/include/eigen3",
    "/usr/include/eigen3",
]
if conda_prefix:
    candidate_eigen_dirs.append(os.path.join(conda_prefix, "include", "eigen3"))
include_dirs = [d for d in candidate_eigen_dirs if os.path.isdir(d)]
