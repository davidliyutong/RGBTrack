...
board_rows = 6
board_cols = 8
image_dir = "/home/xxz/code/toss-reorient/RGBTrack/demo_data/calib_images/rgb"
num_samples = 100
...
# === 保存参数 ===
np.savez(os.path.join(output_dir, "iphone_checkerboard_pinhole_refined.npz"),
         K=K, D=D, rms=rms_refined)
print(f"\nSaved refined parameters to iphone_checkerboard_pinhole_refined.npz")
