...
def main():
    ...
    parser.add_argument("--image", type=str, default="/home/xxz/code/toss-reorient/RGBTrack/demo_data/test/rgb", required=False, help="Path to input RGB image")
    ...
    parser.add_argument("--sam2_checkpoint", type=str, default="/home/xxz/code/toss-reorient/sam2.1_hiera_small.pt", required=False, help="Path to SAM2 checkpoint (.pt)")
